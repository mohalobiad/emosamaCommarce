...
- التحقق يعتمد على backtrace محدود بـ 50 إطارًا لالتقاط مسارات بناء بيانات الـ variations بما في ذلك استدعاءات `WC_Product_Variable::get_available_variation` وطلب الـ AJAX `WC_AJAX::get_variation`.
